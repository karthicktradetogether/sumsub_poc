...
const SUMSUB_APP_TOKEN = 'sbx:5QqhvjpNm7HcbMnsv1Ot3M1f.bgJcom57wQlnKM3rvPsHswS8kfVFvo7S'; // Example: sbx:uY0CgwELmgUAEyl4hNWxLngb.0WSeQeiYny4WEqmAALEAiK2qTC96fBad - Please don't forget to change when switching to production
const SUMSUB_SECRET_KEY = 'vjCrTVdbaS2B0QAEFJRFuevl9V6c0A2X'; // Example: Hej2ch71kG2kTd1iIUDZFNsO5C1lh5Gq - Please don't forget to change when switching to production
...
function addDocument(applicantId) {
    ...
    // var filePath = 'resources/sample_passport.jpg';
...
async function main() {
    ...
    //Applicant ID
    // response = await axios(addDocument('644a29bb295b0262b23e4cbe'))
    //     .then(function (response) {
    //         console.log("Response:\n", response.data);
    //         return response;
    //     })
    ...
    //applicant ID
    // response = await axios(getApplicantStatus('644a0bddc7704704b0d947f4'))
    //     .then(function (response) {
    //         console.log("Response:\n", response.data);
    //         return response;
    //     })
